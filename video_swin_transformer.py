...
except Exception:  # pragma: no cover - best-effort fallback for older timm
...
def get_root_logger(log_file=None, log_level=logging.INFO):
    """Get a simple root logger without mmcv dependency."""
...
def load_checkpoint(model, checkpoint_path, strict=False, logger=None):
    """Lightweight checkpoint loader compatible with common formats.

    It tries 'state_dict' or 'model' keys; otherwise treats the dict as a state dict.
    """
    if logger is None:
...
def get_root_logger(log_file=None, log_level=logging.INFO):
    ...
    """
    return get_root_logger(log_file, log_level)
